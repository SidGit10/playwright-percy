...
WebSQLAccess.pfm_description = "As of M119, if this policy is set to false or unset, WebSQL is disabled, but can be enabled via Chrome flag \"web-sql-access\". If the policy is set to true, WebSQL access is enabled.";
